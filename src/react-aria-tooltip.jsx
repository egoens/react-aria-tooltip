...
class ReactARIAToolTip extends React.Component {
    ...
    render() {
        ...
        return (
            <div onClick={this.handleClick.bind(this)} role="tooltip" className={containerClass}>
                <ToolTipContent
                    message={message}
                    bgcolor={bgcolor}
                    direction={direction}
...
ReactARIAToolTip.propTypes = {
    message: PropTypes.oneOfType([PropTypes.string, PropTypes.object, PropTypes.element])
        .isRequired,
